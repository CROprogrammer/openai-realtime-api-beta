...
export class RealtimeClient extends RealtimeEventHandler {
  ...
  constructor({
    ...
    if (!realtimeDeploymentModel) {
      this.realtimeDeploymentModel = 'gpt-4o-realtime-preview';
    } else {
      this.realtimeDeploymentModel = realtimeDeploymentModel;
    }
    if (!realtimeModelVersion) {
      this.realtimeModelVersion = '2024-10-01-preview';
    } else {
      this.realtimeModelVersion = realtimeModelVersion;
    }
    this.sessionConfig = {};
  ...
  async connect() {
    ...
    await this.realtime.connect(this.realtimeDeploymentModel, this.realtimeModelVersion);
    this.updateSession();
    return true;
  }
