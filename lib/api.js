...
export class RealtimeAPI extends RealtimeEventHandler {
   ...
   * @param modelVersion
   */
  async connect(modelDeployment = 'gpt-4o-realtime-preview', modelVersion = '2024-10-01-preview') {
    ...
    if (globalThis.WebSocket) {
      ...
      const ws = new WebSocket(`${this.url}/openai/realtime?api-key=${this.apiKey}&deployment=${modelDeployment}&api-version=${modelVersion}`, [
        'realtime',
